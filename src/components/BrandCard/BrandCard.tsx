    ...
    return (
        <Grid item xs={4}>
            <Paper variant="outlined" className={classes.resultCardPaper}>
                ...
                <Typography style={{cursor: "pointer"}} variant="h5" onClick={redirectpage}><strong>{BrandName[props.indexNumber]}</strong></Typography>
                ...
                <Typography variant="body1">{FbFollowers[props.indexNumber]} followers &bull; {NumberFBads[props.indexNumber]}ads</Typography>
                <div className={classes.brandLabelsContainer}>
